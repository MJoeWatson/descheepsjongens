...
2) De sloep wordt in de **zelfde staat** terug gebracht als dat deze bij aanvang was. **Controleer** dit bij vertrek, kijk ook hoe het **in** de boot is, zo schoon willen we 'm ook weer terug :) 
...
Wij willen de eindschoonmaak op ons nemen dat wordt dan verrekend met die borg.
...
6) **Pas op met roken** in de boot (ivm brandgaatjes) en scherpe voorwerpen in en aan kleding;
